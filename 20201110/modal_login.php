<div class="modal fade" id="modal_login" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div>
        <input type="text" name="email" id="email" placeholder="Email..." class="input-control col-12" />
        </div>
        <div>
        <input type="password" name="senha" id="senha" placeholder="Senha..." class="input-control col-12" />
        </div>
      </div>
